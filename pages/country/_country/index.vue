...
export default {
    ...
    async asyncData({isDev, route, store, env, params, query, req, res, redirect, error, app}) {
        return app.$axios.get(route.path, {params: { page: query.page, litter: query.litter }})
            .then((res) => {
                return {
                    city: res.data.city,
